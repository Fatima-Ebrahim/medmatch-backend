...
[![Tests](https://github.com/Fatima-Ebrahim/medmatch-backend/actions/workflows/ci.yml/badge.svg)](https://github.com/Fatima-Ebrahim/medmatch-backend/actions)
...
```bash
# 1. Clone repo
git clone https://github.com/Fatima-Ebrahim/medmatch-backend.git
cd medmatch-backend
